        ...
        <div className={styles.home}>
            ...
            <div className={styles.main} id="main">
                ...
                <div className={styles["main-projects"]}>
                    <div className={styles["project-link"]}>
                        <picture>
                            <source
                                srcSet="/personnal-finance-app-mobile.png"
                    ...
                    <div className={styles["project-link"]}>
                        <picture>
                            <source
                                srcSet="/fm-audio-e-commerce-mobile.png"
                                media="(max-width: 700px)"
                            />
                    ...
                    <div className={styles["project-link"]}>
                        <picture>
                            <source
                                srcSet="/kanban-task-management-mobile.png"
                                media="(max-width: 700px)"
                            />
            ...
            <div className={styles.about} id="about">
                <div className={styles["about-text"]}>
                    <h1>ABOUT ME</h1>
                    <div className={styles["blue-marker"]}></div>
                    <p>I'm a frontend developer based out in {location}. I enjoy building responsive, accessible, and user-friendly web applications. My specialities includes TypeScript and React JS.</p>
                </div>
                <div className={styles["about-skills"]}>
                    <h1>My Skills</h1>
                    <div>
                        {mySkills.map((skill :string) => <div className={styles["skill-box"]} key={`skill-${skill}`}>{skill}</div>)}
                    </div>
                </div>
            </div>
